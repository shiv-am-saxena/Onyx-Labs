	...
	return (
		...
		>
			<textarea
				...
				ref={ref}
				className={cn(
					`flex h-28 resize-none items-top justify-start w-full border-none bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm file:border-0 file:bg-transparent 
